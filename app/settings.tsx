          ...
          <View style={styles.section}>
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.backgroundLight, true: theme.colors.primary }}
                thumbColor={settings.keepScreenOn ? theme.colors.accent : theme.colors.textMuted}
              />
            </View>
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.backgroundLight, true: theme.colors.primary }}
                thumbColor={settings.mirrorMode ? theme.colors.accent : theme.colors.textMuted}
              />
            </View>
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.backgroundLight, true: theme.colors.primary }}
                thumbColor={settings.showWordCount ? theme.colors.accent : theme.colors.textMuted}
              />
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.backgroundLight, true: theme.colors.primary }}
                thumbColor={settings.confirmDelete ? theme.colors.accent : theme.colors.textMuted}
              />
            </View>
          </View>
